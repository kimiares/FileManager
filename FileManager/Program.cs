    ...
    class Program<T>
    {
        static void Main(string[] args)
        {
           ...
           // a.Draw();
            ...
            ICheckArea cell = new Cell<string>(new Drawing.Point(0, 0), new Drawing.Point(60, 28), "content");
            cell.CheckArea(new Drawing.Point(5, 11), new Drawing.Point(0, 0), new Drawing.Point(60, 28));
